...
import com.example.citasmedicas_backend.repository.HorarioMedicoRepository;
...
public class HorarioMedicoService {
	...
	public HorarioMedico reserve(Long id) {
		...
		h.setEstadoMedico(com.example.citasmedicas_backend.model.EstadoMedico.RESERVADO);
	...
	public HorarioMedico release(Long id) {
		HorarioMedico h = findById(id);
		if (h == null) return null;
		h.setEstadoMedico(com.example.citasmedicas_backend.model.EstadoMedico.DISPONIBLE);
		return horarioMedicoRepository.save(h);
	}
